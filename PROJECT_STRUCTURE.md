...
[English README](README.md) | [中文 README](README.zh-CN.md) | [Function Guide / 函数说明](FUNCTION_GUIDE.md)
...
|---|---|
| `assets/` | Local PDFs, screenshots, source course materials, and reference images. / 本地 PDF、截图、课程资料和参考图片。 |
